...
<div class="row">
    <div class="col-lg-12 margin-tb d-flex justify-content-between align-items-center mb-3">
        <h2>Bonusni tahrirlash</h2>
        <a class="btn btn-primary" href="{{ route('bonuses.index') }}">&larr; Orqaga</a>
    </div>
</div>
            ...
            <form action="{{ route('admin.bonuses.update', $bonus->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                           id="name" name="name" value="{{ old('name', $bonus->name) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bonus') is-invalid @enderror" 
                           id="bonus" name="bonus" value="{{ old('bonus', $bonus->bonus) }}">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id">
                        ...
                        @foreach ($users as $user)
                            <option value="{{ $user->id }}" {{ (old('user_id', $bonus->user_id) == $user->id) ? 'selected' : '' }}>
                                {{ $user->email }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="given_date" name="given_date" value="{{ old('given_date', $bonus->given_date) }}">
                </div>
                <div class="mb-3">
